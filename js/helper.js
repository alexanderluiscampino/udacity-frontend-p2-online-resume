...
var HTMLfooterText = '<p id="footer-text" class="thin">I\'m' +
                     ...
                     '<a href="https://github.com/d3moid/frontend-nanodegree-resume" target="_blank" class="flow-text yellow lighten-5 black-text hoverable"> Fork the project </a>and see how simple it is!</p>';
